...
export const pos_detail = [
    ...
    {key:'para4',title:'Sales monitoring and reporting', p:'Real-time data. Get all the relevant information you need to keep track and improve your sales and business plan.', img:'/assets/img/features/sales-monitoring.svg'},
    {key:'para5',title:'Offline sales recording', p:'All the data will be saved even when offline and it will sync as soon as you are back online.', img:'/assets/img/features/offline-sales-recording.svg'},
    {key:'para6',title:'Inventory and stock management', p:'Never lose sales by getting out of stock. Smart management system that calculates your usual sales’ amount and notifies you when needed.', img:'/assets/img/features/inventory-and-stock-management.svg'},
    {key:'para7',title:'Staff management', p:'Keeping track of all your employees is just one click away.', img:'/assets/img/features/staff-management.svg'},
    {key:'para8',title:'Manage multiple stores', p:'Thinking about opening a new store? You are able to manage all your businesses from the same platform.', img:'/assets/img/features/manage-multiple-stores.svg'},
...
export const ecommerce_detail = [
    ...
    {key:'para4',title:'Online marketing capability', p:'Highlight current deals, new items, and product recommendation. Popup notification on your regular customer’s mobile.', img:'/assets/img/features/online-marketing-capability.svg'},
    {key:'para5',title:'Professional e-commerce design', p:'Our mobile Ecommerce apps lets you customize your site via the POS with in-built product & brand pictures, categories icon.', img:'/assets/img/features/professional-e-commerce-design.svg'},
...
export const stamps_detail = [
    ...
    {key:'para4',title:'Easy redemption process', p:'Customers will have access to stock and store location data. No lost trips to an specific branch that does not have the product’s availability.', img:'/assets/img/features/easy-redemption-process.svg'},
    {key:'para5',title:'New insights into customers interaction', p:'Get all the insights from your customer’s app usage, which products they like the most, along with which products they buy them, where, when. etc.', img:'/assets/img/features/new-insights-into-customers-interaction.svg'},
    {key:'para6',title:'Get stamps with every purchase', p:'Your customers will earn stamps every time they do a purchase on your shop.', img:'/assets/img/features/get-stamps-with-every-purchase.svg'},
    {key:'para7',title:'Get stamps by playing mini-games', p:'Entertaining mini-games to increase the amount of stamps your customers can obtain.', img:'/assets/img/features/get-stamps-by-playing-mini-games.svg'},
    {key:'para8',title:'Get stamps and deals by filling surveys', p:'Get customer feedback, insights on your target group and reward your shoppers with additional stamps, special deals and promotions.', img:'/assets/img/features/get-stamps-and-deals-by-filling-surveys.svg'},
...
export const analytics_detail = [
    ...
    {key:'para4',title:'Maximize revenue', p:'With new data/insights, trend forecasting and product options.', img:'/assets/img/features/maximize-revenue.svg'},
    {key:'para5',title:'Earn a share of marketing revenue', p:'By collaborating with brands and advertisers.', img:'/assets/img/features/earn-a-share-of-marketing-revenue.svg'},
    {key:'para6',title:'Save money and increase efficiency', p:'Use technology for ordering, inventory and forecasting with a smart management system.', img:'/assets/img/features/save-money-and-increase-efficiency.svg'},
    {key:'para7',title:'Make retailers life easier', p:'Automatize store inventory, analytics and marketing campaigns.', img:'/assets/img/features/make-retailers-life-easier.svg'},
    {key:'para8',title:'Share marketing costs', p:'Potentially increase buying power through collaboration with brands and other stores.', img:'/assets/img/features/share-marketing-costs.svg'},
    {key:'para9',title:'Create integrated experiences', p:'With gamified, incentivized campaigns on our management platform.', img:'/assets/img/features/create-integrated-experiences.svg'}
]

export const help = [
    {key:'q&a1',question:'Is there really no software installation needed to use DSLA POS?' , answer:'Yes, that is correct. DSLA POS works with a cloud base system, which you and only the staff members you chose can access with your credentials from any device with a web browser when online.'},
    {key:'q&a2',question:'Can I access to DSLA POS without an Internet connection?' , answer:'You need an Internet connection to operate our DSLA POS. However, in case of Internet outages or unstable connection, HTML5 offline storage allows processing transactions without being online. Offline records would be uploaded as soon as a connection becomes available.'},
    {key:'q&a3',question:'Is the DSLA POS fast enough?' , answer:'By storing data offline to be readily available, and by receiving real-time updates of all the data, our DSLA POS is able to keep its most used operations lighting fast. This is called an asynchronous transfer.'},
    {key:'q&a4',question:'How to join our DSLA POS?' , answer:"To join our DSLA POS, you can register now by clicking on 'Join Us' and creating your account through the registration form. After that, check your email inbox for a confirmation letter from our DSLA POS, and follow the link included in the email to confirm your email address. Once the registration process is complete, simply click the 'Login' button to access the DSLA POS back office platform."},
