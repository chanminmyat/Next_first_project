  ...
  return (
    <main>
      <div className="relative bg-gradient-to-b from-[#0A0A37] to-[#1D204E] overflow-hidden">
        <div className=" flex lg:flex-row flex-col items-center justify-around sm:py-[100px] py-[30px]">
        ...
        <div className=" bg-white flex flex-col items-center">
          <div className="custom__container md:grid grid-cols-2 gap-[50px] flex-col py-[50px] sm:px-0 px-2 text-justify">
            {help.map((LINK) => (
              <div
                className="flex-col flex items-center mb-[50px] md:mb-0"
                key={LINK.key}
              >
                <div>
                  ...
                  <p className="text-sm text-[#5e5e5e] font-semibold">
                    {LINK.answer}
                  </p>
                </div>
              </div>
          ...
          <div className="w-[100%] bg-[#f2f5f6] flex-col flex items-center">
            ...
            <a href="https://dsla-portal-shared-files.s3.ap-southeast-1.amazonaws.com/rz_pos_guide_en.pdf">
              <span className="mb-[12px] text-[#1f2b7b] text-[18px] font-bold">
                User Guide
              </span>
              <br />
              <Image
