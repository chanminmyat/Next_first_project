      ...
      <main>
        <div className="relative bg-gradient-to-b from-[#0A0A37] to-[#1D204E] overflow-hidden">
          <div className=" flex lg:flex-row flex-col items-center justify-around">
            <h2 className="w-1/2 text-white md:mb-[100px] mb-[50px] text-center font-bold md:text-5xl text-3xl">Online "Click & Collect"</h2>
            <img className="z-10 w-1/2" src="/assets/img/gallery/click-visual.png" alt="" />
          </div>
          ...
          <div className="bg-white flex-col flex items-center">
            <div className='flex flex-col items-center'> 
              ...
              <p className='text-dark-blue text-[20px] text-center mb-[40px]'>
                Integrated
                <span className='text-light-blue'> online solution.</span>
              </p>
            </div>
